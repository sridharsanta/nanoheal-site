    ...
    <div class="ostabs">
      ...
      <div class="ostabs-panel" id="panel-1">
        <div class="osshot">
          ...
          <div class="osshot-image"><span>Screenshot &mdash; Automate Issues</span></div>
        </div>
        <div class="os-cap">
 ...
 real time. No script. No polling. No ticket.</p>
      ...
      <div class="ostabs-panel" id="panel-2">
        <div class="osshot">
          ...
          <div class="osshot-image"><span>Screenshot &mdash; Compliance &amp; Governance</span></div>
        </div>
        <div class="os-cap">
      ...
      <div class="ostabs-panel" id="panel-3">
        <div class="osshot stack">
          ...
          <div class="osshot-image"><span>Screenshot &mdash; Orchestrate the IT Ecosystem</span></div>
        </div>
        <div class="os-cap">
