...
<section class="hero" id="hero">
  <div class="hero-l"><div class="in">
    ...
    <h1>The operating system <span class="q">for the digital workplace.</span></h1>
    <p class="sub">Nanoheal listens to every symptom the OS, application and network already
    report, understands what it means for this device, and acts &mdash; resolving the issue,
    enforcing policy, or orchestrating the rest of the IT ecosystem. No script. No polling.</p>
    <div class="acts">
      <a class="btn btn-solid" href="/#demo">Schedule a Demo</a>
  ...
  <div class="wrap">
    ...
    <div class="os-grid">
      <div class="os-card">
        ...
        <p>Catch the problem. Fix it before it becomes a ticket. Nanoheal listens for symptoms
        reported by the operating system and application environment.</p>
        <p class="os-flow">Detect &rarr; Understand &rarr; Resolve</p>
      </div>
      <div class="os-card">
        <p class="os-num">02</p>
        <h3>Compliance &amp; Governance</h3>
        <p>Know what&rsquo;s out of policy. Put it right. Compliance becomes continuous action,
        not periodic checking.</p>
        <p class="os-flow">Observe &rarr; Identify &rarr; Remediate &rarr; Prove</p>
      </div>
      <div class="os-card">
        <p class="os-num">03</p>
        <h3>Orchestrate the IT Ecosystem</h3>
        <p>The work doesn&rsquo;t stop at the device. Neither does Nanoheal &mdash; one context
        layer, no-code, across every system IT already runs.</p>
        <p class="os-flow">Device &rarr; ITSM &rarr; IT systems &rarr; Human agent</p>
      </div>
    </div>
  </div>
</section>

<section class="band" id="automate-issues">
  <div class="wrap">
    <div class="head">
      <p class="label">01 &mdash; Automate Issues</p>
      <h2 class="h2">Catch the problem. Fix it before it becomes a ticket.</h2>
      <p class="lede">Nanoheal listens for symptoms reported by the operating system and
      application environment &mdash; then decides what to do about them, on the device, in
      real time.</p>
    </div>
    <div class="sig-flow">
    ...
    <p class="sig-proof">No script. No polling. No ticket.</p>
  </div>
</section>

<section class="band bone2" id="compliance-governance">
  <div class="wrap">
    <div class="head">
      <p class="label">02 &mdash; Compliance &amp; Governance</p>
      <h2 class="h2">Know what&rsquo;s out of policy. Put it right.</h2>
      <p class="lede">Observe &rarr; Identify &rarr; Remediate &rarr; Prove. Nanoheal finds the
      deviation and applies the policy &mdash; it doesn&rsquo;t just report it.</p>
    </div>
    <div class="sig-flow">
    ...
    <p class="sig-proof">Compliance becomes continuous action, not periodic checking.</p>
  </div>
</section>

<section class="band" id="orchestrate-ecosystem">
  <div class="wrap">
    <div class="head">
      <p class="label">03 &mdash; Orchestrate the IT Ecosystem</p>
      <h2 class="h2">The work doesn&rsquo;t stop at the device. Neither does Nanoheal.</h2>
      <p class="lede">A digital workplace problem may begin on a device. The work required to
      resolve it usually doesn&rsquo;t end there. One context layer decides what to do, then acts
      wherever the work actually belongs &mdash; no code.</p>
    </div>
    <div class="chain">
...
<section class="band bone2" id="solutions">
  <div class="wrap">
    <div class="head">
