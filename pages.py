...
# ── / ────────────────────────────────────────────────────────────────────────
PAGES["/"] = {
 "title": "Nanoheal — Digital Experience Automation (DXA)",
 "desc": "DEX made the workplace visible. DXA makes it actionable. Nanoheal is the AI-driven "
         "Digital Experience Automation platform that turns DEX insight into autonomous action "
         "— from the device to the entire IT ecosystem.",
 "scripts": '<script src="/assets/plaster.js"></script>',
 "body": """
<section class="hero" id="hero">
  <div class="hero-l"><div class="in">
    <p class="k">AI-driven Digital Experience Automation</p>
    <h1>DEX made the workplace visible. <span class="q">DXA makes it actionable.</span></h1>
    <p class="sub">Nanoheal turns DEX insight into autonomous action &mdash; understanding what a
    symptom means, resolving it at the device, and orchestrating the rest across your IT
    ecosystem. Triggered by the symptom, not by a script.</p>
    <div class="acts">
      <a class="btn btn-solid" href="/#demo">Schedule a Demo</a>
      <a class="btn btn-line" href="/digital-experience-automation/">What is DXA?</a>
    </div>
  </div></div>
  <div class="hero-r">
...
<section class="band bone2" id="gap">
  <div class="wrap">
    <div class="head">
      <p class="label">The gap</p>
      <h2 class="h2">Knowing was solved. Doing wasn&rsquo;t.</h2>
      <p class="lede">DEX made the digital workplace measurable. Enterprises can now see what is
      happening across devices, applications, networks and employee experience. The tickets
      kept coming anyway &mdash; because seeing a problem has never been the same as resolving it.</p>
    </div>
    <div class="ps" style="margin-top:44px">
      <div>
        <p class="t">What DEX gave IT</p>
        <h3>A dashboard that is right about the problem.</h3>
        <p>Scores, trends, anomalies and root cause &mdash; genuine visibility into an estate that
        used to be dark. Every serious DEX platform does this well, and so do we.</p>
      </div>
      <div class="fix">
        <p class="t">What was still missing</p>
        <h3>Anything that closes the ticket.</h3>
        <p>The work of actually fixing it stayed manual, or became a scripting project that
        someone has to write, test, deploy and maintain until it breaks.</p>
      </div>
    </div>
  </div>
</section>

<section class="band" id="framework">
  <div class="wrap">
    <div class="head">
      <p class="label">The category</p>
      <h2 class="h2">This is Digital Experience Automation.</h2>
      <p class="lede">DXA connects DEX intelligence to contextual understanding and autonomous
      action &mdash; so every insight becomes an opportunity to improve the experience, not
      another item in a queue. DEX is the foundation. DXA is what you build on it.</p>
    </div>

    <div class="pf-diagram">
      <div class="pf-col">
        <div class="pf-io"><svg class="scope-ic" viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3"></circle><path d="M3 20c0-3.5 2.7-6 6-6s6 2.5 6 6"></path><circle cx="17" cy="9" r="2.5"></circle><path d="M15 20c.3-2.7 2-4.5 4.5-4.8"></path></svg><div class="pf-io-text"><span class="pf-io-title">People</span><span class="pf-io-desc">Employees &amp; teams</span></div></div>
        <div class="pf-io"><svg class="scope-ic" viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="12" rx="1.4"></rect><path d="M2 19h20"></path></svg><div class="pf-io-text"><span class="pf-io-title">Devices</span><span class="pf-io-desc">Endpoints &amp; applications</span></div></div>
        <div class="pf-io"><svg class="scope-ic" viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l9 5-9 5-9-5 9-5z"></path><path d="M3 13l9 5 9-5"></path></svg><div class="pf-io-text"><span class="pf-io-title">Systems</span><span class="pf-io-desc">ITSM &amp; workplace tools</span></div></div>
        <p class="pf-collabel">Your digital workplace</p>
      </div>

      <span class="pf-connect"><svg viewBox="0 0 24 12" width="24" height="12" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M1 6h18M13 1l6 5-6 5"></path></svg></span>

      <div class="pf-pipe">
        <p class="pf-pipetitle">Digital Experience Automation</p>
        <div class="pf-steps">
          <div class="pf-step"><span class="pf-badge"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="6.5"></circle><path d="M20 20l-4.8-4.8"></path></svg></span><div class="pf-step-text"><span class="pf-step-tag">DEX</span><span class="pf-step-title">Measure</span><span class="pf-step-desc">See what&rsquo;s happening</span></div></div>
          <span class="pf-arrow2"><svg viewBox="0 0 16 10" width="16" height="10" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M1 5h13M9 1l5 4-5 4"></path></svg></span>
          <div class="pf-step"><span class="pf-badge"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M9.5 4.5a2.5 2.5 0 0 0-2.5 2.5 2.5 2.5 0 0 0-2 4 2.5 2.5 0 0 0 1.2 4.3A2.5 2.5 0 0 0 9.5 19.5a2.5 2.5 0 0 0 2.5-2.5v-10a2.5 2.5 0 0 0-2.5-2.5z"></path><path d="M14.5 4.5a2.5 2.5 0 0 1 2.5 2.5 2.5 2.5 0 0 1 2 4 2.5 2.5 0 0 1-1.2 4.3A2.5 2.5 0 0 1 14.5 19.5a2.5 2.5 0 0 1-2.5-2.5v-10a2.5 2.5 0 0 1 2.5-2.5z"></path></svg></span><div class="pf-step-text"><span class="pf-step-tag">Intelligence</span><span class="pf-step-title">Understand</span><span class="pf-step-desc">Know what it means here</span></div></div>
          <span class="pf-arrow2"><svg viewBox="0 0 16 10" width="16" height="10" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M1 5h13M9 1l5 4-5 4"></path></svg></span>
          <div class="pf-step"><span class="pf-badge"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L4.5 13.5H11l-1 8.5 8.5-11.5H12l1-8.5z"></path></svg></span><div class="pf-step-text"><span class="pf-step-tag">DXA</span><span class="pf-step-title">Act</span><span class="pf-step-desc">Resolve, automate, orchestrate</span></div></div>
          <span class="pf-arrow2"><svg viewBox="0 0 16 10" width="16" height="10" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M1 5h13M9 1l5 4-5 4"></path></svg></span>
          <div class="pf-step"><span class="pf-badge"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20V10M10 20V6M16 20v-8M22 20v-4"></path></svg></span><div class="pf-step-text"><span class="pf-step-tag">Outcome</span><span class="pf-step-title">Improve</span><span class="pf-step-desc">Prove the experience got better</span></div></div>
        </div>
      </div>
      ...
      <div class="pf-col">
        <div class="pf-io"><svg class="scope-ic" viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="3.5"></circle><path d="M5 20c0-4 3-6.5 7-6.5s7 2.5 7 6.5"></path></svg><div class="pf-io-text"><span class="pf-io-title">Employees</span><span class="pf-io-desc">Work without interruptions</span></div></div>
        <div class="pf-io"><svg class="scope-ic" viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 13v-1a8 8 0 0 1 16 0v1"></path><rect x="3" y="13" width="4" height="6" rx="1.4"></rect><rect x="17" y="13" width="4" height="6" rx="1.4"></rect><path d="M19 19v1a2 2 0 0 1-2 2h-3"></path></svg><div class="pf-io-text"><span class="pf-io-title">IT / Service Desk</span><span class="pf-io-desc">Resolve issues faster</span></div></div>
        <div class="pf-io"><svg class="scope-ic" viewBox="0 0 24 24" width="34" height="34" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="3" width="14" height="18" rx="1"></rect><path d="M9 8h2M13 8h2M9 12h2M13 12h2M9 16h2M13 16h2"></path></svg><div class="pf-io-text"><span class="pf-io-title">Business</span><span class="pf-io-desc">Higher productivity, better experience</span></div></div>
        <p class="pf-collabel">Better experience</p>
      </div>
    </div>

    <div class="pf-everywhere">
      <span class="pf-ev-label"><svg class="pf-ev-ic" viewBox="0 0 24 24" width="30" height="30" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="12" rx="1.4"></rect><path d="M8 20h8M12 16v4"></path></svg><span class="pf-ev-title">Works everywhere:</span></span>
      <span class="pf-ev-list">Windows &middot; macOS &middot; Linux &middot; VDI &middot; iOS &middot; Android &middot; IoT &middot; Multi-tenant or dedicated</span>
      <span class="pf-ev-cloud"><svg class="pf-ev-ic" viewBox="0 0 24 24" width="30" height="30" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M7.5 18a4.5 4.5 0 0 1-.7-8.94 5.5 5.5 0 0 1 10.6-1.9A4.5 4.5 0 0 1 17 18H7.5z"></path></svg><span class="pf-ev-cloudtext">Cloud, on-prem or airgapped</span></span>
    </div>

    <div style="margin-top:26px">
      <a class="btn btn-line" href="/platform/">See how the platform works</a>
    </div>
  </div>
</section>

<section class="band bone2" id="scope">
  <div class="wrap">
    <div class="head">
      <p class="label">Scope</p>
      <h2 class="h2">Everything DEX does. Then the part that closes the loop.</h2>
      <p class="lede">Measurement is table stakes and we hold the table. What separates Nanoheal
      is what happens in the seconds after the dashboard would have raised an alert.</p>
    </div>
    """ + SCOPE_FLOW + """
...
<section class="band" id="ecosystem">
  <div class="wrap">
    <div class="head">
      <p class="label">Ecosystem automation</p>
      <h2 class="h2">DXA doesn&rsquo;t stop at the device.</h2>
      <p class="lede">A digital experience problem may begin on a device. The work required to
      resolve it usually doesn&rsquo;t end there. One context layer decides what to do, then acts
      wherever the work actually belongs.</p>
    </div>
    <div class="chain">
